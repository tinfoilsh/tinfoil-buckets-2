...
6. GET needs to buffer until the end so we can check the authentication tag. The user can set this with an evnironment var of bufferSize. The user is responsible for memory consumption.
